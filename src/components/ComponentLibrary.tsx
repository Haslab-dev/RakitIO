...
const LIBRARY_COMPONENTS: ComponentDefinition[] = [
  ...
  },
  {
    ...
    height: 52,
    pins: [
      { id: 'positive', name: '+', mode: 'PWM' as never, x: 18, y: 46 },
      { id: 'negative', name: '-', mode: 'GND' as never, x: 34, y: 46 },
    ],
    icon: '🔔',
  },
  {
    ...
    name: 'Relay Module',
    category: 'Actuators',
    description: '5V relay module (SRD-05VDC)',
    width: 80,
    height: 120,
    pins: [
      { id: 'vcc', name: 'VCC', mode: 'VCC' as never, x: 20, y: 108 },
      { id: 'in', name: 'IN', mode: 'INPUT' as never, x: 32, y: 108 },
      { id: 'gnd', name: 'GND', mode: 'GND' as never, x: 44, y: 108 },
      { id: 'com', name: 'COM', mode: 'INPUT' as never, x: 60, y: 108 },
      { id: 'no', name: 'NO', mode: 'INPUT' as never, x: 72, y: 108 },
    ],
    icon: '🔌',
  },
  {
    ...
    height: 70,
    pins: [
      { id: 'vcc', name: 'VCC', mode: 'VCC' as never, x: -10, y: 45 },
      { id: 'out', name: 'OUT', mode: 'ANALOG' as never, x: 10, y: 45 },
      { id: 'gnd', name: 'GND', mode: 'GND' as never, x: -10, y: 45 },
    ],
    icon: '☀️',
  },
  {
    ...
    name: 'PIR Sensor',
    category: 'Sensors',
    description: 'HC-SR501 motion detector',
    width: 70,
    height: 90,
    pins: [
      { id: 'vcc', name: 'VCC', mode: 'VCC' as never, x: -50, y: 50 },
      { id: 'out', name: 'OUT', mode: 'INPUT' as never, x: -50, y: 62 },
      { id: 'gnd', name: 'GND', mode: 'GND' as never, x: 50, y: 62 },
    ],
    icon: '👁',
  },
]
